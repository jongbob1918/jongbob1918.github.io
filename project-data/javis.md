...
<figure class="feature-media"><img src="../assets/images/javis_library_map.webp" alt="Cartographer와 2D LiDAR로 작성한 도서관 점유격자 지도와 로봇 위치" loading="lazy"><figcaption>Cartographer와 2D LiDAR로 작성한 도서관 지도와 로봇 위치</figcaption></figure>
