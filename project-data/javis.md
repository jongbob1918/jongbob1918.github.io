...
team: 9명
period: 2025.09–10
context: ADDINEDU · AI를 활용한 자율주행 로봇개발자 부트캠프 심화과정 7기
role: 자율주행 안정화 · 로봇 작업 제어
skills:
  - ROS 2
  - Python
  - Nav2
...
<figure class="feature-media"><img src="../assets/images/javis_library_map.webp" alt="서가 벽면과 통로, 지정 위치와 로봇 위치가 표시된 도서관 점유격자 지도" loading="lazy"></figure>
...
<figure class="feature-media"><img src="../assets/images/javis_navigation_failure.gif" alt="DWB Controller를 적용한 JAVIS가 좁은 공간에서 회전 경로를 찾지 못하는 초기 주행" loading="lazy"></figure>
...
<figure class="feature-media"><img src="../assets/images/javis_nav_rviz.gif" alt="Smac Planner Hybrid와 MPPI Controller 적용 후 JAVIS가 좁은 서가 사이의 경로를 추종하는 RViz 화면" loading="lazy"></figure>
