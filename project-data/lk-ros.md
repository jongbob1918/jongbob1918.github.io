...
overview: >-
  회사 로봇의 ROS 1 Noetic 기반 소프트웨어를 ROS 2 Humble로 전환했습니다.
  기존 지도 작성·위치 추정 알고리즘 등 필요한 부분을 포팅하고, 행동 트리 기반 의사결정 구조를 도입했습니다.
  위치 추정·주행·관제 통신·의사결정을 각각 모듈화해 여러 로봇에서 재사용할 수 있도록 설계했습니다.
---
...
상태 머신 기반 의사결정 구조를 변경해, 조건 확인과 행동 실행을 트리로 구성하는 행동 트리(Behavior Tree)를 도입했습니다. 의사결정과 개별 기능을 분리하고, 시스템을 다음 네 모듈로 나눴습니다.
