...
overview: >-
  ...
  SO-101 로봇팔 두 대와 2D 카메라를 사용해 색상 공을 집어 수납함에 분류하는 미션에 도전했습니다.
demo:
  type: image
...
<figure class="feature-media hackathon-act-media"><img src="../assets/images/physical-ai-first-attempt.png" alt="수납함 오른쪽의 별 모양 고정 지점을 번갈아 사용한 시연 수집과, 위치 이탈 시 집기 실패·공 낙하 후 정지·수직 접근 중 집게 조기 닫힘을 설명한 그림" loading="lazy"></figure>
...
공 5개를 각각 200회씩 시연해 약 1,000개의 학습 데이터를 수집했습니다. 오전 9시 마감에 맞춰 15,000 step까지 학습한 모델로 심사를 진행했습니다. [공개 최종 모델의 학습 설정](https://huggingface.co/Moment-Lab/act_hackathon_roboseasy_final/blob/main/train_config.json)은 50,000 step으로, 심사에 사용한 모델과 구분됩니다.
