...
<img src="../../../../public/images/notes/easy-deep-learning-ch01/restaurant-rl-01-random-exploration.png" alt="5×5 사각판에서 출발 칸부터 여러 칸을 탐색하다 공사 구간에 들어가 벌점 20을 받는 경로" loading="lazy" />

사각판의 각 칸에 위·아래·왼쪽·오른쪽으로 갔을 때 앞으로 받을 총점의 예상치를 적는다고 생각해 봅시다. 이 점수표가 **Q함수**이고, 출발 칸에서 오른쪽으로 갈 때의 예상치 하나가 **Q값**입니다. **Q-learning**은 이동할 때마다 이 점수를 고칩니다.
