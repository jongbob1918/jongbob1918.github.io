...
지금까지 보상이 좋았던 행동만 반복하면, 아직 시도하지 않은 더 좋은 행동을 놓칠 수 있다. 그래서 탐색과 활용의 균형이 필요하다.

- **탐색**(Exploration): 더 좋은 선택을 찾기 위해 다른 행동을 시도
- **활용**(Exploitation): 현재 알고 있는 정보에서 가장 좋다고 판단한 행동을 선택

##### 방법 예시: ε-greedy

탐색과 활용을 확률로 나누는 방법이다.
